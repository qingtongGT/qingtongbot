...
INTERACTION_PATH = DATA_PATH / "interaction"
IMAGE_PATH = DATA_PATH / "image"
SOMEIMAGE_PATH = DATA_PATH / "someImage"
AUTOREPLY_PATH = DATA_PATH / "autoReply"
...
def check_path() -> bool:
    ...
    if not SOMEIMAGE_PATH.exists():
        SOMEIMAGE_PATH.mkdir(parents=True, exist_ok=True)
    if not AUTOREPLY_PATH.exists():
        AUTOREPLY_PATH.mkdir(parents=True, exist_ok=True)
    return flag
